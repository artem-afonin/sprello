<template>
    <div class="card text-center">
        ...
        <ul class="list-group list-group-flush">
            <site-task-element v-for="el in task.elements" :key="el.id" :element="el"/>
            <li class="list-group-item">
                <button class="btn btn-outline-success text-center font-weight-bolder"
                        data-toggle="modal"
        ...
        <div class="modal fade" :id="`addModal${task.id}`" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input class="form-control mt-3" v-model="createdElement.text" type="text" maxlength="48"
                                   placeholder="Введите новый текст подзадачи">
                        </div>
                    </div>
                    <div class="modal-footer text-center">
                        <button type="button" @click="createElem"
        ...
        <!-- Кнопки -->
        <div class="card-body">
            <button type="button" class="btn btn-info mr-3 font-weight-bolder" data-toggle="modal"
                    :data-target="`#changeModal${task.id}`">
                Править название
            </button>

            <!-- Модальное окно правки -->
            <div class="modal fade" :id="`changeModal${task.id}`" tabindex="-1" role="dialog"
                 aria-labelledby="changeModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input class="form-control mt-3" v-model="changedTask.name" type="text" maxlength="48"
